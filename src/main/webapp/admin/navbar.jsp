...
<nav class="navbar navbar-expand-lg navbar-dark " style="background-color: 	#ba55d3">
	<div class="container-fluid">
		<a class="navbar-brand" href="index.jsp"><i class="fa-sharp fa-solid fa-stethoscope"></i>  Arogya</a>
