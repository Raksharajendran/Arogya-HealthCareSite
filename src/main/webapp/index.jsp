			...
			<div class="col-md-8 p-5">
				<div class="row">
					...
					<div class="col-md-6 mt-2">
						<div class="card paint-card">
							<div class="card-body">
								<p class="fs-5">Friendly Environment</p>
								<p>Lorem ipsum dolor sit amet,consectetur adipisicing elit.
									voluptatem, inventore</p>
							</div>
						</div>
			...
			<div class="col-md-3">
				<div class="card paint-card">
					<div class="card-body text-center">
						...
						<p class="fw-bold fs-5">Dr.Keerthana</p>
			...
			<div class="col-md-3">
				<div class="card paint-card">
					<div class="card-body text-center">
						...
						<p class="fw-bold fs-5">Dr.Stefy</p>
						<p class="fs-7">(Chief Doctor)</p>
					</div>
				</div>
			</div>
			<div class="col-md-3">
				<div class="card paint-card">
					<div class="card-body text-center">
						...
						<p class="fw-bold fs-5">Dr.Karthick</p>
						<p class="fs-7">(Chief Doctor)</p>
					</div>
				</div>
			</div>
